...
public class Utility {
	...
	public static String ReplyHTML(String comm, String nickname, int n_num, String pw) {
		...
		HTML += "<div class='media-body'><span class='text-muted pull-right'> <small class='text-muted'>" + times
				+ "</small>";
		HTML += "<br><span class='text-muted pull-right'><button class='btn btn-outline-dangerous' onclick='deleted(this)' data-nnum='"
				+ n_num + "' data-name='" + nickname + "' data-pw='" + pw
				+ "'>삭제</button></span></span> <strong class='text-success'>@" + nickname + "</strong>";
		HTML += "<p>" + comm;
		HTML += "</p></div></li>";
		return HTML;
	}
