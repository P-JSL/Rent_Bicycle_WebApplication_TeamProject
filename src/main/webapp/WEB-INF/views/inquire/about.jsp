	...
	<div id="root">
		<div class="App">
			<section class="content" id="guide-cont">
				<div class="wrap">
					<section class="howto">
						<h2 class="sub-title">自転車レンタルホームページの利用方法をお知らせ頂きます！。</h2>
							...
							<li class="mv moveit"><h3>
								...
								<section class="banner-01" style="overflow: hidden;">
									<sec:authorize access="isAuthenticated()">
										<a href="/inquire" class="btn btna2 mv3 moveit">「レンタル予約のお問い合わせ」する見る</a>
									</sec:authorize>
									<sec:authorize access="isAnonymous()">
										<a href="javascript:loginmove();"
											class="btn btna2 mv3 moveit">「レンタル予約のお問い合わせ」する見る</a>
									</sec:authorize>
								</section></li>
							<li class="mv moveit"><h3>
									<span>3</span> 自転車探し
					...
					<section class="banner-01" style="overflow: hidden;">
						...
						<h2>
							<span>レンタル利用料金</span>도<br> 確認して下さい。
						</h2>
						<a href="/fare" class="btn btna2 mv3 moveit">サービス料金すぐみる</a>
					</section>
