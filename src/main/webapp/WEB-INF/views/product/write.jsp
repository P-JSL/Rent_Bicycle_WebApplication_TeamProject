...
<div class="notice">
	...
	<div class="notice-write">
		...
		<form name="write" style="background-color: #6daeb8"
			action="/product/write" method="post" enctype="multipart/form-data">
				...
				<table class="table">
					...
					<tr>
						...
						<td ><input type="text" name="category"
							...
							<th style="vertical-align: middle;"><label for="t_title">작성자</label></th>
						<td colspan="3"><input type="text" name="title" id="title" class="title"
							readonly value="<sec:authentication property='principal.member.userid'/>"></td>
					</tr>
					<tr>
						...
						<td colspan="3"><input type="file" name="goodsfile"
							id="title" class="title"></td>

					</tr>
					<tr>
						<th style="vertical-align: middle;"><label for="cont">내용</label></th>
						<td colspan="5"><textarea type="cont" name="content"
								id="cont" class="cont" placeholder="내용을 입력해주세요"></textarea>
					</tr>


					<tr>
						<td colspan="5"><input type="submit" value="저장" class="btn"
