					...
					<div class="col-xl-4 col-md-6 col-lg-4 ">
						<div class="footer_widget">
							<div class="footer_logo">
								<a href="#"> <img src="${pageContext.request.contextPath}/resources/img/footer_logo.png" alt="">
								</a>
							</div>
							<p>
						...
						<div class="footer_widget">
							...
							<div class="instagram_feed">
								<div class="single_insta">
									<a href="#"> <img src="${pageContext.request.contextPath}/resources/img/instagram/1.png"
										alt="">
									</a>
								</div>
								<div class="single_insta">
									<a href="#"> <img src="${pageContext.request.contextPath}/resources/img/instagram/2.png"
										alt="">
									</a>
								</div>
								<div class="single_insta">
									<a href="#"> <img src="${pageContext.request.contextPath}/resources/img/instagram/3.png"
										alt="">
									</a>
								</div>
								<div class="single_insta">
									<a href="#"> <img src="${pageContext.request.contextPath}/resources/img/instagram/4.png"
										alt="">
									</a>
								</div>
								<div class="single_insta">
									<a href="#"> <img src="${pageContext.request.contextPath}/resources/img/instagram/5.png"
										alt="">
									</a>
								</div>
								<div class="single_insta">
									<a href="#"> <img src="${pageContext.request.contextPath}/resources/img/instagram/6.png"
										alt="">
									</a>
								</div>
							</div>
