							...
							<form class="form-horizontal form-material">
								<div class="form-group">
									...
									<div class="col-md-12">
										...
										<input type="text" class="form-control form-control-line" value="<sec:authentication property='principal.member.userid'/>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">User Password</label>
									<div class="col-md-12">
										<input type="text" class="form-control form-control-line" value="${user.userpw}" >
									</div>
								</div>
								<div class="form-group">
