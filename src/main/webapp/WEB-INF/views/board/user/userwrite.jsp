...
<div class="notice">
	<div class="sub-notice">
		<h2>
			<span><i class="fas fa-edit"></i> USER-NOTICE-write</span>
		</h2>
	</div>
	...
	<div class="notice-write">
		...
		<form name="write" style="background-color: #6daeb8"
			enctype="Multipart/form-data" action="/usernotice/Userwrite"
			method="post">
			...
			<fieldset>
				...
				<table class="table">
					...
					<tr>
						...
						<th style="vertical-align: middle;"><label for="t_title">닉네임</label>
						</th>
						<c:choose>
							<c:when test="${user.nickname eq null }">
								<td><input type="text" name="nickname" id="title"
									class="title"></td>
							</c:when>
							<c:when test="${user.nickname ne null }">
								<td><input type="text" name="nickname" id="title"
									class="title" value="${user.nickname }" readonly></td>
							</c:when>
						</c:choose>
					</tr>
