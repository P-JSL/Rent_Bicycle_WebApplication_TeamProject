...
<div class="notice">
	<div class="sub-notice">
		<h2>
			<span><i class="fas fa-edit"></i> USER-NOTICE-update</span>
		</h2>
	</div>

	<div class="notice-write">

		<form name="write" style="background-color: #6daeb8" enctype="multipart/form-data"
			action="/usernotice/Usermodify" method="post">
			<input type="hidden" name="${_csrf.parameterName}"
				value="${_csrf.token}"> 
			<input type="hidden" name="userid"
				value="<%=request.getParameter("userid")%>">
				<input type="hidden" name="goodsphoto" value="${vo.goodsphoto }">
				...
				<table class="table">
					...
					<tr>
						...
						<td><textarea type="cont" name="content" id="cont"
								class="cont" placeholder="${vo.content}" ></textarea>
					</tr>
	<tr>
						<th style="vertical-align: middle;"><label for="cont">첨부파일</label></th>
						<td><input type="file" name="goodsfile"></td>
					</tr>
					<tr>
						<td colspan="2">
						<input type="submit" value="저장" class="btn" onclick="noticeSave()"> 
						<input type="button" onclick="history.back();" value="목록" class="btn"></td>
					</tr>
