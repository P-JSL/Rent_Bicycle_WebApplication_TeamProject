...
<div class="action" onclick="actionToggle();">
	...
	<ul>
		...
		<li><i class="fa fa-question-circle-o fa-fw" aria-hidden="true"><a
				href="/usernotice/Usernotice">&nbsp;&nbsp;&nbsp;Usernotice</a></i></li>
	</ul>
</div>
<div class="container">
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body text-center">
					<h3 class="card-title m-b-0">자유게시판</h3>
				</div>
				<div class="notice-write"></div>
						...
						<thead class="thead-light" style="text-align: center;">
							<tr>
								...
								<th style="text-align: center;"><i
									class="fa fa-thumbs-o-up fa-2x" aria-hidden="true" style="color: green;"></i></th>
								<th style="text-align: center;"><i class="fa fa-eye fa-fw fa-2x" aria-hidden="true"></i></th>
								<th style="text-align: center;"><i class="fa fa-picture-o fa-2x" aria-hidden="true"></i></th>
							</tr>
						</thead>
						<tbody class="customtable">
							...
							<c:forEach items="${list }" var="vo">
								<tr
									...
									<td>${bno}</td>
									<td><a
										href="/usernotice/UserView?sequence=${vo.sequence }&nickname=${vo.nickname}&pageNum=${pageMaker.cri.pageNum}">${vo.title }</a></td>
									<td>${vo.nickname }</td>
									<td>${vo.recommend }</td>
									<td>${vo.viewer }</td>
									<td><img style="max-width: 70px;"
										src="/upload/upload/${vo.goodsphoto }"></td>
				...
				<nav aria-label="Page navigation example"
					...
					<form id="actionForm" action="/usernotice/UserWrite" method="get">
...
<form id="actionForm" action="/usernotice/Usernotice" method="get"></form>
