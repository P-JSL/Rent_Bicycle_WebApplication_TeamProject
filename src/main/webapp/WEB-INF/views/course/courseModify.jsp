...
<div class="notice">
	...
	<div class="notice-write">
		...
		<form name="write" style="background-color: #6daeb8"
			action="/course/courseModifyok" method="post" enctype="multipart/form-data">
			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"> 
				<input type="hidden" name="userid" value="${userid }">
				<input type="hidden" name="num" value="${Cview.num}">
				<input type="hidden" name="photo" value="${Cview.photo }">
